...
import { addTaskCommentController, completeTaskController, createTaskController, deleteTaskController, getMyTaskController, getOverdueTaskController, getTaskByIdController, getTaskByTodoListController, getTaskStatsController, restoreTaskController, updateTaskController } from "../controllers/task.controller.js";
...
taskRouter.patch('/:todoListId/:taskId/restore', auth, restoreTaskController);
